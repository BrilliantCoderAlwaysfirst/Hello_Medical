...
const PurchaseList = () => {
  ...
  function purchaseList() {
    fetch(
      `http://pykro.com/medicalstore/public/api/ListPurchaseEntry?userId=${userId}`
    )
  ...
  function deletePurchase(id) {
    ...
    fetch(
      `http://pykro.com/medicalstore/public/api/DeletePurchaseEntry?id=${id}`
    ).then((res) => res.json());
                  ...
                  (data) => (
                    <tr>
                      ...
                      >
                        ...
                        <button onClick={() => deletePurchase(data.id)}>
                          Delete
                        </button>
                      </td>
                    </tr>
